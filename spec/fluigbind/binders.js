describe("fluigbind.binders", function() {
  var context;
  ...
  describe("value", function() {
    ...
    it("unbinds the same bound function", function() {
      ...
      fluigbind.binders.value.bind.call(context, el);

      sinon.stub(el, 'removeEventListener', function(event, fn) {
        fn.should.equal(boundFn)
      });

      fluigbind.binders.value.unbind.call(context, el)
    })
  });
  ...
  describe("each-*", function() {
    ...
    it("binds to the model creating a list item for each element in items", function() {
      var view = fluigbind.bind(fragment, model);
  ...
  describe("nested-each-*", function() {
    ...
    it("lets you access index from current and parent scope", function() {
      ...
      var view = fluigbind.bind(el, model);
  ...
  describe("Custom binder with no attribute value", function() {
    var el, model;
    fluigbind.binders["custom-binder"] = function(el, value) {
